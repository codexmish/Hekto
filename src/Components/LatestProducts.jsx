  ...
  return (
    <>
      <div className="container">
        <CommonSectionHead head={"Leatest Products"} />

        <div className="flex justify-center items-center gap-6 lg:gap-14 mt-2 text-sm lg:text-[18px] text-navyBlue font-bold lg:font-normal font-lato">
